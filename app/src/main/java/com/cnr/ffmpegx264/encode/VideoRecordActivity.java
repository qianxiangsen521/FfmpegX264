package com.cnr.ffmpegx264.encode;
...
//                String path = Environment.getExternalStorageDirectory().getPath() + filename;
                ...
                FFmpegBridge.initMediaRecorder(file.getAbsolutePath(), mImageWidth, mImageHeight, mImageWidth, mImageHeight,
                        25, 5760000, true, 40000, 44100);
                Log.d("TAG", "run: "+mImageWidth+"--"+mImageHeight);
